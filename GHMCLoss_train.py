...
# parser.add_argument('--config', default='experiments/cifar10-ghm-GHMCLossV2/config.yaml')
parser.add_argument('--config', default='experiments/cifar10-ghm/config.yaml')
...
def main():
    ...
    criterion = GHMC_Loss(momentum=config.GHM_momentum)
