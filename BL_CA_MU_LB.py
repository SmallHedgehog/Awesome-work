...
parser = argparse.ArgumentParser(description='ResNet32+CosineAnnealing+Mixup+LabelSmoothing')
parser.add_argument('--config', default='experiments/cifar10-bl_ca_mu_lb/config.yaml')
