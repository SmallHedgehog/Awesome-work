...
parser = argparse.ArgumentParser(description='Decoupled Weight Decay Regularization trick in ResNet32 network')
parser.add_argument('--config', default='experiments/cifar10-dwdr/config.yaml')
