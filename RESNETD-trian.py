...
parser = argparse.ArgumentParser(description='Model Tweaks of resnet-d architecture')
parser.add_argument('--config', default='experiments/cifar10-resnetd/config.yaml')
